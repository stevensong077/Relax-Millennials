...
<head>
	...
	<title>Lobby - Relax, millennials</title>
...
<body id="page-top" class="index about_body">
	...
	<div class="container-fluid  bg-light-gray" style="margin:60px; padding:2%">
		<br>
		<div class="col-md-12">
			<div class="why-right">
				<div class="content-area">
					<p style="text-align: center; font-size:150%;">
						Following a 30-minute reading session, people would demonstrate a reduction of stress on the Daily Stress <br>
						Inventory (DSI) and a decrease in blood pressure and heart rate (Rizzolo & Zipp, 2009).<br><br>
						When individuals write about emotional experiences, significant physical and mental health <br>
						improvements follow (James, 1997).
					</p>
				</div>
			</div>
		</div>
	...
	<center>
		<form class="form-signin" action="game.php" method="post" style="width:300px; margin-top:75px; margin-bottom:75px;">
			<div class="input-group">
				<span class="input-group-addon">Nick Name</span>
				<input id="username" name="username" type="text" class="form-control" minlength="2" maxlength="12" required placeholder="Enter your preferred name" />
			</div>
			<button type="submit" class="button button-3d button-primary button-rounded">Join the Game</button>
		</form>
	</center>
